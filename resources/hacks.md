<div align="center">
  ...
  <p>
    ...
    5. Add the keyword  "<b>javascript:</b>"  .<br>
    6. Paste the script, and click enter.<br>
    7. Follow any instructions (in popups) on the Betastar page.
  </p>
  <br>
  <br>
  <br>
  <h3>Element Chance Calculator</h3>
  <p>
...
```
  ...
  <h3>Spam Open Crates</h3>

  <p>Quickly get elements from any crate. Works QUITE quickly.</p>
